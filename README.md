...
basic usage instructions, some examples for the actual use of the dataset, validation source code for the quality
assurance of the dataset, and data quality reports generated by [DQ-Kit](https://dqkit.bonares.de), version 1.0.
...
We provide some examples for the actual use of the dataset in the [`examples`](examples) directory. These are merely the
first steps for subsequent analyses.
...
These files represent the reports generated by [DQ-Kit](https://dqkit.bonares.de), version 1.0, from BonaRes.
